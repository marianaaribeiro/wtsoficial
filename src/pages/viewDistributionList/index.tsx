...
import useViewDistributionListHelper from "./viewDistributionList.helper";

const ViewDistributionList = () => {
    const { resources,
        valueDataStart,
        valueDataEnd,
        isLoading,
        ...
        goCreatPage,
        goBackPage } = useViewDistributionListHelper();
        ...
        <LayoutDashboard>
            ...
            >
                <Box sx={{ flexDirection: "row" }}>
                    ...
                    />
                    <Box sx={{ mt: 5, mb: 5 }}>
                        <Button variant="text" onClick={() => goBackPage()} disabled={isLoading || isRefetching}> {`< ${resources.textButtonBack}`}</Button>
                        <Button variant="contained" onClick={() => goCreatPage()} disabled={isLoading || isRefetching}>{resources.textButton}</Button>
                    </Box>
                    {/* list filtros */}
                    <Stack direction="row"
                        ...
                        <Box sx={{ minWidth: 79, width: { lg: "auto", md: "auto", sm: "45%", xs: "35%" }, mx: { lg: 3, md: 0, sm: 0, xs: 0 }, display: "inline-flex", justifyContent: { lg: "center", md: "center", sm: "flex-start", xs: "flex-end" }, alignItems: "center" }}>
                            <InputSelects
                                title="Estado da Lista de Distribuição"
                                sx={{ minWidth: 79 }}
                                disabled={isLoading || isRefetching}
                                label="Estado da Lista de Distribuição"
            ...
            <CustomDialog
                ...
                title="Criar Lista de Distribuição"
